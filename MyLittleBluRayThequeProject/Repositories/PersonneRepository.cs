    ...
    public class PersonneRepository
    {
        ...
        public Personne GetRealisateurOfBluRay(long idBr)
        {
            ...
            try
            {
                ...
                // Define a query returning a single row result set
                NpgsqlCommand command = new NpgsqlCommand("SELECT \"p\".\"Id\", \"p\".\"Nom\", \"p\".\"Prenom\", \"p\".\"DateNaissance\", \"p\".\"Nationalite\" FROM \"BluRayTheque\".\"Personne\" AS p JOIN \"BluRayTheque\".\"Realisateur\" AS a ON \"a\".\"IdRealisateur\" = \"p\".\"Id\" JOIN \"BluRayTheque\".\"BluRay\" AS b ON \"a\".\"IdBluRay\" = \"b\".\"Id\" ", conn);
        ...
        public Personne GetScenaristeOfBluRay(long idBr)
        {
            ...
            try
            {
                ...
                // Define a query returning a single row result set
                NpgsqlCommand command = new NpgsqlCommand("SELECT \"p\".\"Id\", \"p\".\"Nom\", \"p\".\"Prenom\", \"p\".\"DateNaissance\", \"p\".\"Nationalite\" FROM \"BluRayTheque\".\"Personne\" AS p JOIN \"BluRayTheque\".\"Scenariste\" AS a ON \"a\".\"IdRealisateur\" = \"p\".\"Id\" JOIN \"BluRayTheque\".\"BluRay\" AS b ON \"a\".\"IdBluRay\" = \"b\".\"Id\" ", conn);
